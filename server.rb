    ...
    if message.chat
      ...
      when Telegram::Bot::Types::Message
        ...
        when /он/
          ...
          bot.api.send_message(chat_id: message.chat.id, text: answers.sample)
        when /гей/
          answers = ['Гей', 'Нам похуй', 'С ботом играть в игры - это нужно быть пид*лиз*м', 'Тут боты ссорятся', 'Лобок побрей', 'Пиздализ', 'Тут нужен семейный врач', 'Слава Украине', 'Слава нации', 'Ебальник закрой', 'Ебани разок', 'Ты бот? LoL', 'Ебать', 'Донбасс', 'скинь член']
          bot.api.send_message(chat_id: message.chat.id, text: answers.sample)
        when /лол/
