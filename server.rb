    ...
    if message.chat
      ...
      when Telegram::Bot::Types::Message
        ...
        when /еноту/
          ...
          bot.api.send_message(chat_id: message.chat.id, text: answers.sample)
        when /Алежа/
          answers = ['Закрой рот', 'Закрой поддувало', 'Шма забань всех', 'Клоун ты', 'Ты уебок совсем?', 'Я в игры не играю','Хантер х хантер, лучшее аниме', 'Он сдох', 'Алежка гей', 'Пидорнулся', 'Мальчик пи*ар', '@dmitrybereza свят!', 'Ог уже занят', 'Просвяти', 'А Алежа в постели бревно', 'Зачем жука трогаешь?', 'ты ему не интересен', 'Это вообще нацизм', 'Напиши лонг стори']
          bot.api.send_message(chat_id: message.chat.id, text: answers.sample)
        when /жук/
